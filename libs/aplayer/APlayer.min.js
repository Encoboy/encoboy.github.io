  ...
  return (function (e) {
      ...
      var o = (function () {
        ...
        O = (function () {
          function e(t) {
            if (
              (a(this, e),
              (this.options = (0, h.default)(t)),
              (this.container = this.options.container),
              (this.playIndex = 0),
              (this.paused = !0),
              (this.playedPromise = l.default.resolve()),
              (this.mode = "normal"),
              (this.randomOrder = u.default.randomOrder(
              ...
              [
                  ...
                  value: function () {
                    ...
                    this.on("play", function () {
                      ...
                      this.on("durationchange", function () {
                        1 !== e.audio.duration &&
                          (e.template.dtime.innerHTML = u.default.secondToTime(
                            e.audio.duration
                          ));
                      }),
                      ...
                      this.on("ended", function () {
                        "none" === e.options.loop
                          ? "list" === e.options.order
                            ? e.playIndex < e.options.audio.length - 1
                              ? (e.switchAudio(
                                  (e.playIndex + 1) % e.options.audio.length
                                ),
                                e.play())
                              : (e.switchAudio(
                                  (e.playIndex + 1) % e.options.audio.length
                            ...
                            : "random" === e.options.order &&
                              (e.randomOrder.indexOf(e.playIndex) <
                              e.randomOrder.length - 1
                                ? (e.switchAudio(e.nextRandomNum()), e.play())
                                : (e.switchAudio(e.nextRandomNum()), e.pause()))
                          : "one" === e.options.loop
                          ? (e.switchAudio(e.playIndex), e.play())
                          : "all" === e.options.loop &&
                            ("list" === e.options.order
                              ? e.switchAudio(
                                  (e.playIndex + 1) % e.options.audio.length
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    this.handlePlayPromise(function () {
                      ...
                      n.cover
                        ? (t.template.pic.style.backgroundImage =
                            "url('" + n.cover + "')")
                        : (t.template.pic.style.backgroundImage = ""),
                        t.theme(),
                        (t.template.title.innerHTML = n.name),
                        (t.template.author.innerHTML = n.artist
                          ? " - " + n.artist
                          : "");
                      var i =
                        t.container.getElementsByClassName(
                          "aplayer-list-light"
                        )[0];
                      i && i.classList.remove("aplayer-list-light"),
                        t.container
                          .querySelectorAll(".aplayer-list li")
                          [t.playIndex].classList.add("aplayer-list-light"),
                        (t.template.list.scrollTop = 33 * t.playIndex),
                        t.hls && (t.hls.destroy(), (t.hls = null));
                      var a = n.type;
                      t.options.customAudioType && t.options.customAudioType[a]
                        ? "[object Function]" ===
                          Object.prototype.toString.call(
                            t.options.customAudioType[a]
                          )
                          ? t.options.customAudioType[a](t.audio, n, t)
                          : console.error("Illegal customType: " + a)
                        : ((a && "auto" !== a) ||
                            (a = /m3u8(#|\?|$)/i.exec(n.url)
                              ? "hls"
                              : "normal"),
                          "hls" === a
                            ? Hls.isSupported()
                              ? ((t.hls = new Hls()),
                                ...
                                t.hls.attachMedia(t.audio))
                              : t.audio.canPlayType("application/x-mpegURL") ||
                                t.audio.canPlayType(
                                  "application/vnd.apple.mpegURL"
                                )
                              ? (t.audio.src = n.url)
                              : t.notice("Error: HLS is not supported.")
                            : "normal" === a && (t.audio.src = n.url)),
                        t.seek(0);
                      var o = void 0;
                      return (
                        t.paused ||
                          (o = l.default
                            .resolve(t.audio.play())
                            .catch(function (e) {
                              console.error(e), t.pause();
                            })),
                        t.lrc && t.lrc.switch(t.playIndex),
                        1 !== t.audio.duration &&
                          (t.template.dtime.innerHTML = t.audio.duration
                            ? u.default.secondToTime(t.audio.duration)
                            : "00:00"),
                        o
                      );
                    });
                ...
                },
                {
                  ...
                  value: function () {
                    var e =
                        arguments.length > 0 && void 0 !== arguments[0]
                          ? arguments[0]
                          : this.options.audio[this.playIndex].theme,
                      t =
                ...
                },
                {
                  ...
                  value: function (e) {
                    (e = Math.max(e, 0)),
                      this.audio.duration &&
                        (e = Math.min(e, this.audio.duration)),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.handlePlayPromise(function () {
                      ...
                      var t = l.default
                        .resolve(e.audio.play())
                        .catch(function (t) {
                          console.error(t), e.pause();
                        });
                      if ((e.timer.enable("loading"), e.options.mutex))
                  ...
                  value: function () {
                    ...
                    this.handlePlayPromise(function () {
                      e.paused ||
                        ...
                        e.audio.pause(),
                        e.container.classList.remove("aplayer-loading"),
                  ...
                  value: function (e) {
                    ...
                    for (var n = "", i = 0; i < e.length; i++)
                      n +=
                        ...
                        (e[i].theme || this.options.theme) +
                        ';"></span><span class="aplayer-list-index">' +
                        (this.options.audio.length - e.length + i + 1) +
                    ...
                    (this.template.listOl.innerHTML += n),
                      t &&
                        ...
                        (this.container.classList.add("aplayer-withlist"),
                        (this.audio.loop = !1)),
                      (this.template.list.style.height =
                        33 * this.options.audio.length - 1 + "px"),
                      (this.template.listOl.style.height =
                        33 * this.options.audio.length - 1 + "px"),
                      (this.randomOrder = u.default.randomOrder(
                        this.options.audio.length
                      )),
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (
                      (this.events.trigger("removeaudio", e),
                      this.options.audio[e] && this.options.audio.length > 1)
                    ) {
                      var t =
                        this.container.querySelectorAll(".aplayer-list li");
                      this.options.audio.splice(e, 1),
                        e === this.playIndex &&
                          (this.options.audio[e + 1]
                            ? this.switchAudio(e)
                            : this.switchAudio(e - 1)),
                ...
                },
                {
                  ...
                  value: function (e) {
                    this.playedPromise = this.playedPromise
                      .then(e)
                      .catch(function (e) {
                        console.error(e);
                      });
        ...
        function r(e, t) {
          try {
            ...
            if (
              ...
              if ("function" == typeof n) return void c(i(n, t), e);
            }
        ...
        (a.prototype.catch = function (e) {
          ...
          (a.all = function (e) {
            return new a(function (t, n) {
              ...
              for (var o = a.length, r = 0; r < a.length; r++) i(r, a[r]);
            });
          }),
    ...
    function (e, t, n) {
      ...
      function l() {
        m &&
          f &&
          ((m = !1), f.length ? (y = f.concat(y)) : (v = -1), y.length && s());
      }
      function s() {
        if (!m) {
          var e = o(l);
      ...
      (h.nextTick = function (e) {
        ...
        y.push(new u(e, t)), 1 !== y.length || m || o(s);
      }),
            ...
            o(e, [
              {
                ...
                value: function () {
                  ...
                  (e =
                    ...
                    (this.container.innerHTML = (0, u.default)({
                      options: this.options,
                      icons: l.default,
                      cover: e,
                    })),
      ...
      e.exports = function (e) {
        ...
        return (
          ...
          o.audio.length > 1 &&
            ...
            "list" === o.order
              ? (t += r.orderList)
              : "random" === o.order && (t += r.orderRandom),
            (t += "\n                </button>\n                ")),
          (t +=
      ...
      (function (t) {
        ...
        function a(e) {
          ...
          for (a = n.index, o = 0; a < t.length; a++) {
            ...
            o !== a && (i += t.substring(o, a)), (o = a + 1), (i += r);
          }
        ...
        l = (function () {
          function e(t) {
            i(this, e),
              ...
              (this.default = { volume: t.options.volume || 0.7 }),
              (this.data = {}),
              this.init();
          }
          return (
                ...
                value: function (e) {
                  ...
                  if (!this.parsed[e])
                    if (this.async) {
                      ...
                      this.content[e]
                        ? (this.parsed[e] = this.parse(this.content[e]))
            ...
            o(e, [
              {
                ...
                value: function () {
                  var e = this;
                  this.player.template.pic.addEventListener(
                    "click",
                    function () {
                      e.player.toggle();
                    }
                ...
                value: function () {
                  ...
                  this.player.template.list.addEventListener(
                    ...
                    function (t) {
                      ...
                      i !== e.player.playIndex
                        ? (e.player.switchAudio(i), e.player.play())
                        : e.player.toggle();
                    }
                  );
                },
                  ...
                  var e = this,
                    t = function (t) {
                      ...
                      (n = Math.max(n, 0)),
                        ...
                        e.player.lrc &&
                          e.player.lrc.update(n * e.player.audio.duration),
                        (e.player.template.ptime.innerHTML =
                          l.default.secondToTime(n * e.player.audio.duration));
                    },
                    n = function n(i) {
                      document.removeEventListener(
                        l.default.nameMap.dragEnd,
                        n
                      ),
                        document.removeEventListener(
                          l.default.nameMap.dragMove,
                          t
                        );
                      var a =
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  (this.player.template.list.style.height =
                    33 * this.player.options.audio.length - 1 + "px"),
                    (this.player.template.listOl.style.height =
                      33 * this.player.options.audio.length - 1 + "px"),
                    this.player.template.menu.addEventListener(
                      "click",
                      function () {
                        e.player.template.list.classList.contains(
                          "aplayer-list-hide"
                        )
                          ? e.player.template.list.classList.remove(
                              "aplayer-list-hide"
                            )
                          : e.player.template.list.classList.add(
                              "aplayer-list-hide"
                            );
                      }
                    );
